...
export class Player extends GameObject {
    ...
    private headBob: number; // 頭の上下動
    private idleSway: number; // アイドル時の左右ゆれ
    private hairSway: number; // 髪の左右ゆれ
    private hatTilt: number; // 帽子の傾き
    private currentExpression: string; // 表情
    private armSwing: number; // 腕の振り
    private gloveStretch: number; // 手袋の伸び
    private legSwing: number; // 足の振り
    private toolBeltSwing: number; // ツールベルトの揺れ
    private footStep: number; // 足音エフェクト
